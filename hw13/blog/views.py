...
def about(request):
    return simple_page(request, 'blog/about.html')

def contact(request):
    return simple_page(request, 'blog/contact.html')

def blog(request):
    return simple_page(request, 'blog/blog.html')
